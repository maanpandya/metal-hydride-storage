# the code below has been directly copied from the tutorial website with 0 changes, it should run without issues!
...
function setup_grid(h = 0.05)
    ...
    # Convert directly from GMSH to Ferrite Grid without writing to file
